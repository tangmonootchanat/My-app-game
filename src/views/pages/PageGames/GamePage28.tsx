...
const GamePage: React.FC = () => {
  ...
  const [cardImages, setCardImages] = useState<CardProps[]>([
    ...
    { id: 8, image: Img8, isFlipped: false, isMatched: false },
    { id: 9, image: Img9, isFlipped: false, isMatched: false },
    { id: 10, image: Img10, isFlipped: false, isMatched: false },
    { id: 11, image: Img11, isFlipped: false, isMatched: false },
    { id: 12, image: Img12, isFlipped: false, isMatched: false },
  ]);
...
useEffect(() => {
  ...
  const handleCardClick = (id: number) => {
    if (matchedCards.includes(id) || openedCards.length === 24) {
      return;
    }
    ...
    <ThemeProvider theme={currentTheme}>
      ...
      <ContainerWrapper>
          ...
          <CardContainer>
            ...
            <CardRow>
              {cardImages.slice(12, 18).map((card) => (
                <Card
                    key={card.id}
                    id={card.id}
                    image={card.image}
            ...
            <CardRow>
              {cardImages.slice(18, 24).map((card) => (
                <Card
                    key={card.id}
                    id={card.id}
                    image={card.image}
