...
import BearLose from '../component/Images/Tikker22.png';
import GameOver from '../component/Images/GameOver.png';
    ...
    <ThemeProvider theme={currentTheme}>
      <Overlay>
        <PopupCard theme={currentTheme}>
          <img src={GameOver} alt="winIcon"/>
          <img src={BearLose} alt="Bear" />
          <ButtonContainer>
